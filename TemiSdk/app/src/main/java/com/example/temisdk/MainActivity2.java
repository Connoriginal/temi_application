...
import com.example.temisdk.Adapter.MainActivity2Adapter;
...
public class MainActivity2 extends AppCompatActivity
    ...
    MainActivity2Adapter adapter;// 대화내용 기록을 위한 어답터
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MainActivity2Adapter(this , list);
